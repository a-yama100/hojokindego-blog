      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 mb-6">
        ...
        <div className="flex gap-3">
          <button onClick={doSearch} disabled={loading}
            className="px-6 py-2 bg-emerald-700 text-white font-bold rounded-lg hover:bg-emerald-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer text-sm">
