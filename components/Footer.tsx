        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 text-sm">
              Find and compare Japanese government subsidies and grants for businesses.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/tools" className="text-gray-400 hover:text-white transition-colors">ツール</Link></li>
              <li><Link href="/downloads" className="text-gray-400 hover:text-white transition-colors">ダウンロード</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/feed.xml" className="text-gray-400 hover:text-white transition-colors">RSS Feed</a></li>
            </ul>
          </div>
        </div>
        
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
          1995-{currentYear} Hojokin de Go!. All Rights Reserved.
        </div>
      </Container>
    </footer>
  )
